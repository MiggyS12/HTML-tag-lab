...
class RubyAdapter {
    ...
    load() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.getTestFramework() === "rspec") {
                ...
                const loadedTests = yield this.testsInstance.loadTests();
    ...
    run(tests, debuggerConfig) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.testsInstance) {
                yield this.testsInstance.runTests(tests, debuggerConfig);
            }
        });
    }
    debug(testsToRun) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let debugSession;
            try {
                yield this.testsInstance.debugCommandStarted();
                debugSession = yield this.startDebugging(debuggerConfig);
            }
            catch (err) {
    ...
    startDebugging(debuggerConfig) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const started = yield vscode.debug.startDebugging(this.workspace, debuggerConfig);
            if (started) {
    ...
    getTestDirectory() {
        ...
        let testDirectory = '';
        if (testFramework === 'rspec') {
            testDirectory = vscode.workspace.getConfiguration('rubyTestExplorer', null).get('rspecDirectory') || './spec/';
        }
        else if (testFramework === 'minitest') {
            testDirectory = vscode.workspace.getConfiguration('rubyTestExplorer', null).get('minitestDirectory') || './test/';
        }
